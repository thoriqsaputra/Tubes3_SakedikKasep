...
//         Console.WriteLine("Masukkan pola:");
//         string pattern = Console.ReadLine();

//         // Melakukan pencocokan menggunakan algoritma KMP
//         int matchPosition = KMPAlgorithm.KmpMatch(text, pattern);

//         // Jika pola ditemukan, hitung tingkat kemiripan menggunakan Levenshtein Distance
//         if (matchPosition != -1)
//         {
//             string matchedSubstring = text.Substring(matchPosition, pattern.Length);
//             double similarity = KMPAlgorithm.CalculateLevenshteinSimilarity(matchedSubstring, pattern);
//             Console.WriteLine($"Pola ditemukan pada posisi: {matchPosition}");
//             Console.WriteLine($"Tingkat kemiripan (berdasarkan Jarak Levenshtein): {similarity}%");
//         }
//         else
//         {
